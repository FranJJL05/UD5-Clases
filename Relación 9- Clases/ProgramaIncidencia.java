public class ProgramaIncidencia {
    public static void main(String[] args) {
        Incidencia inc1 = new Incidencia(105, "No tienes acceso a internet ");
        ...
        Incidencia inc5 = new Incidencia(111, "Se cuelga al abrir tres ventanas");
        inc2.resuelve("El equipo no estaba enchifado");
